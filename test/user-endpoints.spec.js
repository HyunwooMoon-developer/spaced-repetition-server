    ...
    describe(`Given a valid user`, () => {
      ...
      it(`inserts 1 language with words for the new user`, () => {
        ...
        const expectedList = {
          ...
          total_score: 0,
          words: [
            { original: "안녕하세요", translation: "Hello" },
            { original: "감사합니다", translation: "Thank you" },
            { original: "집", translation: "house" },
            { original: "개발자", translation: "developer" },
            { original: "생각", translation: "Thinking" },
            { original: "고양이", translation: "Cat" },
            { original: "강아지", translation: "Dog" },
            { original: "나라", translation: "Country" },
          ],
        };
        return supertest(app)
          .post("/api/user")
